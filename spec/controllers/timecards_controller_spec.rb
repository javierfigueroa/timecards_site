  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved timecard as @timecard" do
        ...
        post :create, {:timecard => { "latitude" => "invalid value" }}, valid_session
        assigns(:timecard).should be_a_new(Timecard)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested timecard" do
        ...
        Timecard.any_instance.should_receive(:update_attributes).with({ "latitude" => "1.5" })
        put :update, {:id => timecard.to_param, :timecard => { "latitude" => "1.5" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the timecard as @timecard" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Timecard.any_instance.stub(:save).and_return(false)
        put :update, {:id => timecard.to_param, :timecard => { "latitude" => "invalid value" }}, valid_session
        assigns(:timecard).should eq(timecard)
      end
